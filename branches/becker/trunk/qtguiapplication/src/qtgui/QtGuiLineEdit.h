...
/*
 * $Source: /data/cvs/qtguiapplication/qtgui/qtgui/QtGuiLineEdit.h,v $
 * $Revision: 1.1 $
...
#ifndef _QtGuiLineEdit_h
#define _QtGuiLineEdit_h
#include "QtGui.h"
#include "QtGuiDialogItem.h"

class QtGuiLineEditPrivate;

class QtGuiLineEdit : public QtGuiDialogItem {
  Q_OBJECT
 public:
  QtGuiLineEdit(MLParser *parser=0, ArgDict* argdict=0);
  ~QtGuiLineEdit();
...
//  virtual void connectObject();
 ...
 private:  
  QtGuiLineEditPrivate* data_;
};

QtGuiLineEdit *newQtGuiLineEdit(MLParser *parser, ArgDict* argdict=0);
