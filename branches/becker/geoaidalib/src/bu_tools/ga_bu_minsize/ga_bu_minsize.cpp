...
int main(int argc, char *argv[])
{
  ...
  //BottomUp bu("/project/geoaida/share/data/test_files/ga_bu_minsize/input-27656-0171");
  ...
  QFile fp(argv[2]);
  //QFile fp("/project/geoaida/share/data/test_files/ga_bu_minsize/outfile");
  ...
  while(it.current()) { //run over list
		...
		if (size>=minsize) node1->write(str);
		++it;
		it.toFirst();
	}	
	str<<"/>\n";
