...
int main(int argc, char *argv[])
{
    ...
    if (ArgvList.size() > 0)
    {
        ...
        if (ArgvList.size() == nNumberOfChannels+4)
        {
            ...
            Extractor.extract();
            Classifier.loadModel(ArgvList[nNumberOfChannels+1]);
            Classifier.loadScaling(ArgvList[nNumberOfChannels+2]);
            ...
            Classifier.classify();
            Classifier.saveClassificationResult(ArgvList[nNumberOfChannels+3]);
        }
        else
        {
